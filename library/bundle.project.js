...
cc.Class({
    ...
    //-----------------------界面刷新---------------------------------------
    //手牌图片刷新
    refreshCardSprite: function refreshCardSprite() {
        var player = this.duel.getPlayer(this.idx);
    ...
    //随从图片刷新
    refreshMonsterSprite: function refreshMonsterSprite() {
        var player = this.duel.getPlayer(this.idx);
